var messages = {
  ...
  labelFooter: {
    ...
    uz:
      "Tomas Parkning 'Flexbox Froggy' o'yinining o'zbek tiliga moslashtirilgan talqini."
  },
  labelLevel: {
    en: 'Level',
    ro: 'Nivelul',
  ...
  title: {
    ...
    lt:
      'Flexbox Froggy - Žaidimas padėsiantis perprasti CSS "flexbox" metodiką',
    ...
    uz: "Fleksboks oshxonasi - CSS Fleksboks (Flexbox) o'rganish uchun o'yin"
  },
  labelReset: {
    en: 'Reset',
    ro: 'Resetează',
